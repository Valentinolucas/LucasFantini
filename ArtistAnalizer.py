    ...
    def artistRecords(self, id):
        ...
        try:
            result = musicbrainzngs.get_artist_by_id(
                self.id, includes=["release-groups"], release_type=["album", "ep"]
            )
        except:
            return False
        else:
    ...
    def releaseSongs(self, artist, release_name):
        ...
        try:
            ...
            result = musicbrainzngs.get_release_by_id(
                releaseId, includes=["recordings"], release_status=[], release_type=[]
            )
    ...
    def analizeLyrics(self, artist, songs):
        ...
        for song in songs:
            try:
                ...
                url = "https://orion.apiseeds.com/api/music/lyric/{artist}/{song}?apikey={key}".format(
                    artist=self.artist, song=song, key=API_KEY
                )
